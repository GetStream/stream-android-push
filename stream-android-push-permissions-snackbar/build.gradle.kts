...
mavenPublishing {
    val artifactId = "stream-android-push-permissions-snackbar"
    coordinates(
...
kotlin {
    ...
    sourceSets {
        ...
        commonMain {
            dependencies {
                api(project(":stream-android-push-permissions"))
...
android {
    ...
    namespace = "io.getstream.android.push.permissions.snackbar"
    defaultConfig {
