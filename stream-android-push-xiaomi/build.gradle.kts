...
mavenPublishing {
    val artifactId = "stream-android-push-xiaomi"
    coordinates(
    ...
    sourceSets {
        ...
        commonMain {
            dependencies {
                ...
                api(project(":stream-android-push-delegate"))
        ...
        androidMain {
            dependencies {
                compileOnly(files("libs/MiPush_SDK_Client_5_1_8-G_3rd.aar"))
...
android {
    ...
    namespace = "io.getstream.android.push.xiaomi"
    defaultConfig {
